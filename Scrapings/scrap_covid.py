...
def loader():
    ...
    for i in aux:
        ...
        if i.lower().endswith('.zip') and 'Entregas_' in i:
        ...
        elif i.lower().endswith('.rar') and 'Entregas_' in i:
...
dfsclean = map(lambda x: cleaner(x), dfs)
...
test = analise['casosNovos']['2022-06':]
